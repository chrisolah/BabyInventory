...
//     Rooloop as the concierge in the middle — the user never has to
//     coordinate with another parent directly.
//   • Receiver opt-in gets its own section, with non-stigmatizing framing
//     ("Open to receiving hand-me-downs" / "Another Rooloop family").
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <p className={styles.sub}>Track every onesie, plan every size, and send outgrown clothes on to Rooloop, another family, a friend or family member, or a charity — all from the same app.</p>
        ...
        <div className={styles.scanFeatureWrap}>
          <div className={styles.scanFeatureCopy}>
            ...
            <p className={styles.scanFeatureBody}>
              Point your phone at a clothing tag &mdash; Rooloop reads the
      ...
      {/* ── Pass-along hub — the V1.9 centerpiece ───────────────────────────
          Four destinations, one flow, Rooloop as the concierge in the
      ...
      <section className={styles.hub} ref={hubRef}>
        <div className={styles.hubBand}>
          ...
          <p className={styles.hubBody}>Pick a destination and Rooloop takes it from there. No selling, no drop-off logistics, no swapping addresses with strangers. Every batch is one less bag in the landfill &mdash; and one less new garment manufactured to take its place.</p>
          <div className={styles.hubGrid}>
            <div className={styles.hubCard}>
              ...
              <div className={styles.hubCardTitle}>Rooloop</div>
            ...
            <div className={styles.hubCard}>
              ...
              <div className={styles.hubCardTitle}>Another Rooloop family</div>
      ...
      <section className={styles.optIn}>
        ...
        <p className={styles.optInBody}>Any Rooloop household can opt in to receiving hand-me-downs. Pick sizes, pick genders, pause whenever. No applications, no listings to browse — we match you to a sender when the fit is right, and mail it.</p>
        <div className={styles.optInRow}>
          ...
          <div className={styles.optInBullet}>
            ...
            <div className={styles.optInBulletText}><strong>We do the matching.</strong> When a sender picks &ldquo;Another Rooloop family,&rdquo; we route the box to one of you.</div>
          </div>
          <div className={styles.optInBullet}>
      ...
      <section className={styles.mission}>
        <div className={styles.missionBand}>
          ...
          <p className={styles.missionBody}>Babies outgrow clothes in weeks &mdash; most still have years of life left. Rooloop keeps them moving: out of your house, into another baby&rsquo;s drawer, never into landfill. With as little friction for you as possible.</p>
          <button className={styles.missionCta} onClick={handleJoinCommunity}>Join Rooloop</button>
