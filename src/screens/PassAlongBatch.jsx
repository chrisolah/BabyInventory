...
const DESTINATION_OPTIONS = [
  ...
  {
    id: 'family',
    label: 'Another Littleloop family',
    sub: 'Ships to Littleloop first — we forward to a matched family who\u2019s opted in to receiving.',
  },
  {
    id: 'person',
...
const STATUS_LABEL = {
  draft: 'Draft',
  shipped: 'Shipped',
  received: 'Received at Littleloop',
  fulfilled: 'Fulfilled',
  canceled: 'Canceled',
}
...
function timelineFor(destination) {
  ...
  return [
    { key: 'draft', label: 'Draft' },
    { key: 'shipped', label: 'Shipped to Littleloop' },
...
export default function PassAlongBatch() {
  ...
  function confirmBody() {
    ...
    if (pendingAction === 'ship') {
      ...
      return 'Mark this batch as sent. Littleloop will update you once we\u2019ve received it.'
    }
      ...
      <main className={styles.body}>
        ...
        {!loading && batch && (
          <>
            ...
            <section className={styles.section}>
              ...
              {destination === 'family' && (
                <div className={styles.familyExplainer}>
                  <strong>How this works:</strong> The box ships to Littleloop
                  first. We check the contents, match them to another
                  Littleloop family that’s opted in to receiving, and
              ...
              <div className={styles.instructionsBox}>
                <ul className={styles.instructionsList}>
                  ...
                  {(destination === 'littleloop' || destination === 'family') && (
                    <li>
                      Ship to Littleloop. You’ll get the shipping address
            ...
            <section className={styles.section}>
              <div className={styles.sectionTitle}>
                Notes <span className={styles.optional}>(for yourself or Littleloop)</span>
              </div>
              <textarea
                className={styles.textarea}
                rows={3}
